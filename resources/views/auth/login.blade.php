...
<head>
    <meta charset="UTF-8">
    <title>Animated SVG Avatar v2</title>
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
    <link rel="stylesheet" href="{{asset('template/gentelella/build/css/login.css')}}">
</head>
<body>
...
<form action="{{ route('login') }}" method="POST">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input placeholder="email@domain.com" id="loginEmail" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
...
<script src="{{asset('template/gentelella/build/js/MorphSVGPlugin.min.js')}}"></script>
<script src="{{asset('template/gentelella/build/js/login.js')}}"></script>
